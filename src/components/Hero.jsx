...
const Hero = () => {
  ...
  return (
    <section className="w-full nav-height bg-black relative">
        ...
        <a href="#highlights" className="px-5 py-2 rounded-3xl bg-blue my-5 hover:bg-transparent border border-transparent hover:border hover:text-blue hover:border-blue transition-all">Buy</a>
